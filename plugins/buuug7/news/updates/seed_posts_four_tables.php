...
class SeedPostsFourTables extends Seeder{
    public function run()
    {
        ...
        $zhenCeJieDu01 = Post::create([
            ...
            'published' => true,
            'published_at' => Carbon::createFromFormat('Y-m-d','2017-6-8'),
            //'featured' => true,
            //'image' => '/news/01.jpg',
            'user_id' => 1,
            'images' => [],
        ...
        $zhenCeJieDu02 = Post::create([
            ...
            'published' => true,
            'published_at' => Carbon::createFromFormat('Y-m-d','2017-6-11'),
            //'featured' => true,
            //'image' => '/news/01.jpg',
            'user_id' => 1,
            'images' => [],
        ...
        $zhenCeJieDu03 = Post::create([
            ...
            'published' => true,
            'published_at' => Carbon::createFromFormat('Y-m-d','2017-6-16'),
            //'featured' => true,
            //'image' => '/news/01.jpg',
            'user_id' => 1,
            'images' => [],
        ...
        $zhenCeJieDu04 = Post::create([
            ...
            'published' => true,
            'published_at' => Carbon::createFromFormat('Y-m-d','2017-6-22'),
            //'featured' => true,
            //'image' => '/news/01.jpg',
            'user_id' => 1,
            'images' => [],
